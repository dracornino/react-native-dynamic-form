...
export default class DynamicForm extends Component {
  ...
  renderForm = () => {
    const { form, submitButton, onIconPressed } = this.props;
          ...
          return (
            <View key={key} style={styles.row}>
              <CustomDate
                ...
                value={this.getFormElementValue(key, element)}
                onDateChange={(value) => {
                  this.updateFormElement(moment(value).toISOString(true), element);
                }}
                disabled={element.disabled}
          ...
          return (
            <View key={key} style={styles.row}>
              <CustomPhoto
                ...
                value={this.getFormElementValue(key, element)}
                onPhotoChange={(uri) => {
                  this.updateFormElement(uri, element);
                }}
                disabled={element.disabled}
              />
            </View>
